    ...
    <NcAppContent>
        <div id="app-navigation" class="">
            ...
            <ul id="usergrouplist">
                ...
                <li><a href="/index.php/apps/dsonextcloud/taken">Taken</a></li>
            ...
            <div id="app-content-wrapper">
                <div class="app-content-list">
                    <a href="#" class="app-content-list-item">
                        <input type="checkbox" id="test1" class="app-content-list-item-checkbox checkbox"
                            checked="checked"><label for="test1"></label>
                    ...
                    <a href="#" class="app-content-list-item">
                        ...
                        <div class="app-content-list-item-line-one">Important mail is very important! Don't ignore me
                        </div>
                        <div class="app-content-list-item-line-two">Hello there, here is an important mail from your mom
                        </div>
                    </a>
                    <a href="#" class="app-content-list-item">
