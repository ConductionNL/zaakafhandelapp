<!--
 ...
 The manifest-v2 migration replaced it with the declarative "BerichtDetail"
 page (/berichten/:id), which the library renderer draws through
 ...
 @visual exclude Dead file: superseded by the manifest-v2 "BerichtDetail" page (/berichten/:id); imported by no module in src/, so it is in no bundle and no e2e can mount it. The live page is covered by tests/e2e/spec-coverage/ui-detail-views.spec.ts. Correct fix is deletion.
-->
<script setup>
		...
		<div id="app-content">
			...
			<div v-if="berichtStore.berichtItem">
				...
				<div class="tabContainer">
					<CnTabs content-class="mt-3" justified :aria-label="t('zaakafhandelapp', 'Message details')">
