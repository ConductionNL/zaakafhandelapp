<!--
 ...
 The manifest-v2 migration replaced it with the declarative "BesluitDetail"
 page (/besluiten/:id), which the library renderer draws through
 ...
 @visual exclude Dead file: superseded by the manifest-v2 "BesluitDetail" page (/besluiten/:id); imported by no module in src/, so it is in no bundle and no e2e can mount it. The live page is covered by tests/e2e/spec-coverage/ui-detail-views.spec.ts. Correct fix is deletion.
-->
<script setup>
