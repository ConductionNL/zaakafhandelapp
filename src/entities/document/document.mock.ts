 ...
 *
 */
export function mockDocumentData(): TDocument[] {
	return [
		{
			...
			informatieobjecttype:
				'https://example.com/catalogi/informatieobjecttypen/1',
			locked: false,
			bestandsdelen: [
				{
 ...
 * @param data
 */
export function mockDocument(data: TDocument[] = mockDocumentData()): TDocument[] {
	return data.map((item) => new Document(item))
}
