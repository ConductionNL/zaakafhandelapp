...
- [x] 1.2 Verify: `grep -rL 'SPDX-License-Identifier' lib --include='*.php'` returns nothing; the `spdx-headers` gate is green; `openspec validate add-spdx-license-headers --strict` is clean.
